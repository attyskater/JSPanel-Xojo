...
Inherits WebSDKUIControl
	...
	#tag Event
		Function ExecuteEvent(name As String, parameters As JSONItem) As Boolean
		  ...
		  case "onclosedChild"
		    ...
		    var idChild as String 
		    if Parameters.HasKey("controlID") then
		      
		      idChild = Parameters.Value("controlID").StringValue
		      
		      for i as integer = 0 to DockContainer.ubound
		        if DockContainer(i).ControlID = idChild then
	...
	#tag Event
		Sub Serialize(js As JSONItem)
		  ...
		  js.value("minResizeHeight") =minResizeHeight
		  js.value("minResizeWidth") =minResizeWidth
		  ...
		  js.value("syncMargins") =syncMargins
		  js.value("onparentresize") =onparentresize
	...
	#tag Property, Flags = &h0
		minResizeHeight As Integer = 38
	#tag EndProperty

	#tag Property, Flags = &h0
		minResizeWidth As Integer = 128
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		onparentresize As Boolean = false
	#tag EndProperty
